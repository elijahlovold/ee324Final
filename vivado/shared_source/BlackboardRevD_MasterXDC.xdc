...
#set_property -dict { PACKAGE_PIN T19   IOSTANDARD LVCMOS33 } [get_ports { led[4] }]; #IO_25_34 Schematic=LD4
#set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { led[5] }]; #IO_L3P_T0_DWS_PUDC_B_34 Schematic=LD5
#set_property -dict { PACKAGE_PIN V20   IOSTANDARD LVCMOS33 } [get_ports { led[6] }]; #IO_L16P_T2_34 Schematic=LD6
#set_property -dict { PACKAGE_PIN W20   IOSTANDARD LVCMOS33 } [get_ports { led[7] }]; #IO_L16N_T2_34 Schematic=LD7
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { led[8] }]; #IO_L22N_T3_34 Schematic=LD8
#set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { led[9] }]; #IO_L17N_T2_34  Schematic=LD9

##RGB_LEDS
#set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { RGB_led_0[0] }]; #IO_L22P_T3_34  Schematic=LD10_R
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { RGB_led_0[1] }]; #IO_L18N_T2_34 Schematic=LD10_G
#set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { RGB_led_0[2] }]; #IO_L17P_T2_34 Schematic=LD10_B

#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { RGB_led_1[0] }]; #IO_L8N_T1_34 Schematic=LD11_R
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { RGB_led_1[1] }]; #IO_L7P_T1_34 Schematic=LD11_G
#set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { RGB_led_1[2] }]; #IO_L7N_T1_34 Schematic=LD11_B

##Switches
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { portal1 }]; #IO_L19N_T3_VREF_34 Schematic=SW0
set_property -dict { PACKAGE_PIN U20   IOSTANDARD LVCMOS33 } [get_ports { portal2 }]; #IO_L15N_T2_DQS_34 Schematic=SW1
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { boost }]; #IO_L19P_T3_34 Schematic=SW2
...
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { sw[8] }]; #IO_L1N_T0_34 Schematic=SW8
#set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33 } [get_ports { sw[9] }]; #IO_L2P_T0_34 Schematic=SW9
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { sw[10] }]; #IO_L1P_T0_34 Schematic=SW10
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { rst }]; #IO_L5P_T0_34 Schematic=SW11

#Buttons
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { up }]; #IO_L8P_T1_34 Schematic=BTN0
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { down }]; #IO_L4N_T0_34 Schematic=BTN1
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { right }]; #IO_L24P_T3_34 Schematic=BTN2
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { left }]; #IO_L23P_T3_35 Schematic=BTN3
...
set_property -dict { PACKAGE_PIN U17   IOSTANDARD TMDS_33 } [get_ports hdmi_cec]; #IO_L9N_T1_DQS_34 Sch=HDMI_TX_CEC
set_property -dict { PACKAGE_PIN P16   IOSTANDARD TMDS_33 } [get_ports hdmi_hpd]; #IO_L24N_T3_34 Sch=HDMI_TX_HPD
set_property -dict { PACKAGE_PIN F17   IOSTANDARD TMDS_33 } [get_ports hdmi_out_en]; #IO_L6N_T0_VREF_35 Sch=HDMI_OUT_EN
set_property -dict { PACKAGE_PIN T17   IOSTANDARD TMDS_33 } [get_ports hdmi_scl]; #IO_L20P_T3_34 Sch=HDMI_TX_SCL
set_property -dict { PACKAGE_PIN R18   IOSTANDARD TMDS_33 } [get_ports hdmi_sda]; #IO_L20N_T3_34 Sch=HDMI_TX_SDA
...
##PmodC
#set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { JC1_P }]; #IO_L10P_T1_34 Sch=JC1
#set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports { JC1_N }]; #IO_L10N_T1_34 Sch=JC2
#set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { JC2_P }]; #IO_L18P_T2_34 Sch=JC3
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { JC2_N }]; #IO_L9P_T1_DQS_34 Sch=JC4
#set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { JC3_P }]; #IO_L7P_T1_AD2P_35 Sch=JC7
#set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { JC3_N }]; #IO_0_35 Sch=JC8
#set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { JC4_P }]; #IO_L16P_T2_35 Sch=JC9
#set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { JC4_N }]; #IO_L19N_T3_VREF_35 Sch=JC10
